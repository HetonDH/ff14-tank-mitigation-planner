...
const copy = {
  zh: {
    ...
    steps: [
      ...
      ["3. 认识减伤分类", "大减通常指铁壁和各职业 120 秒主减；小减/特色减多用于平 A 或补死刑；支援减可以给搭档 T；团减用于 AOE；无敌是长 CD 的逃课资源。"],
      ["4. 校对事件", "点击时间轴上的事件，在右侧详情里把类型改成机制、平 A、死刑或 AOE，并校对伤害属性。机制不会参与自动排轴。"],
      ["5. 一键生成", "点击“一键生成最佳减伤”。死刑会尝试大减、小减、特色减叠加；双 T 死刑会分别给 MT/ST 排轴；AOE 优先团减和雪仇；平 A 优先短 CD 小减。"],
  ...
  en: {
    ...
    steps: [
      ...
      ["3. Learn mitigation groups", "Big mits are Rampart and 120s job defensives; short/unique mits help autos and tankbusters; support mits can cover your co-tank; party mits cover AOE; invulns are long-cooldown cheese tools."],
      ["4. Check events", "Click an event and set its type to Mechanic, Auto, Tankbuster, or AOE. Mechanics are ignored by auto planning."],
      ["5. Generate plan", "Click Generate Best Plan. Tankbusters get layered mitigation, double tankbusters plan MT/ST separately, AOE prefers party mitigation/Reprisal, and autos prefer short cooldowns."],
