...
const copy = {
  zh: {
    ...
    steps: [
      ...
      ["2. 导入战斗记录", "优先粘贴 FFLogs 报告链接并点击“按报告链接导入”。如果临时没有链接，也可以上传 FFLogs JSON 或本地日志文件作为兜底。"],
  ...
  en: {
    ...
    steps: [
      ...
      ["2. Import fight log", "Prefer pasting a FFLogs report URL and clicking Import Report URL. You can also upload FFLogs JSON or a local log file as fallback."],
