...
export const tankSkills: MitigationSkill[] = [
  ...
  { id: "pld-bulwark", actionId: 22, job: "PLD", zhName: "壁垒", enName: "Bulwark", icon: "/i/000000/000167.png", category: "personal", cooldown: 90, duration: 10, mitigationPercent: 20, damageType: "all", targeting: "self", canTargetPartner: false, isInvuln: false, minLevel: 52, statusIds: [77], notes: "格挡类减伤，算法按 20% 基础减伤近似。" },
  ...
  { id: "pld-sheltron", actionId: 25746, job: "PLD", zhName: "圣盾阵", enName: "Sheltron", icon: "/i/002000/002950.png", category: "personal", cooldown: 5, duration: 8, mitigationPercent: 15, damageType: "all", targeting: "self", canTargetPartner: false, isInvuln: false, minLevel: 35, statusIds: [2674, 2675], resourceType: "pldOath", resourceCost: 50, notes: "消耗 50 点忠义值；算法按开场 100、自动攻击积攒忠义值近似。" },
  { id: "pld-cover", actionId: 27, job: "PLD", zhName: "保护", enName: "Cover", icon: "/i/002000/002501.png", category: "target", cooldown: 120, duration: 12, mitigationPercent: null, damageType: "all", targeting: "selected", canTargetPartner: true, isInvuln: false, minLevel: 45, statusIds: [79], resourceType: "pldOath", resourceCost: 50, notes: "消耗 50 点忠义值；替目标承受部分攻击，实际可用性受距离与机制判定影响。" },
  { id: "pld-intervention", actionId: 7382, job: "PLD", zhName: "干预", enName: "Intervention", icon: "/i/002000/002512.png", category: "target", cooldown: 10, duration: 8, mitigationPercent: 10, damageType: "all", targeting: "selected", canTargetPartner: true, isInvuln: false, minLevel: 62, statusIds: [1174, 2675], resourceType: "pldOath", resourceCost: 50, notes: "消耗 50 点忠义值；可给搭档 T。若自身带铁壁/极致防御，效果按更高减伤近似。" },
  ...
  { id: "pld-passage-of-arms", actionId: 7385, job: "PLD", zhName: "武装戍卫", enName: "Passage of Arms", icon: "/i/002000/002515.png", category: "party", cooldown: 120, duration: 5, mitigationPercent: 15, damageType: "all", targeting: "party", canTargetPartner: false, isInvuln: false, minLevel: 70, statusIds: [1176], notes: "按实际团减生效窗口近似为 5 秒；需要面向与站位。" },
  ...
  { id: "war-nascent-flash", actionId: 16464, job: "WAR", zhName: "原初的勇猛", enName: "Nascent Flash", icon: "/i/002000/002567.png", category: "target", cooldown: 25, duration: 8, mitigationPercent: 10, damageType: "all", targeting: "selected", canTargetPartner: true, isInvuln: false, minLevel: 76, statusIds: [1857, 1858] },
  ...
  { id: "drk-shadow-wall", actionId: 3636, job: "DRK", zhName: "暗影墙", enName: "Shadow Wall", icon: "/i/003000/003075.png", category: "personal", cooldown: 120, duration: 15, mitigationPercent: 30, damageType: "all", targeting: "self", canTargetPartner: false, isInvuln: false, minLevel: 38, maxLevel: 91, statusIds: [747], notes: "92 级后升级为暗影卫；100 级副本通常只显示暗影卫。" },
