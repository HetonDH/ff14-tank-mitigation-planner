...
export const tankSkills: MitigationSkill[] = [
  ...
  { id: "pld-sentinel", job: "PLD", zhName: "预警", enName: "Sentinel", category: "personal", cooldown: 120, duration: 15, mitigationPercent: 30, damageType: "all", targeting: "self", canTargetPartner: false, isInvuln: false, minLevel: 38, maxLevel: 91, notes: "92 级后由预警精通升级为戍卫。" },
  { id: "pld-guardian", job: "PLD", zhName: "戍卫", enName: "Guardian", category: "personal", cooldown: 120, duration: 15, mitigationPercent: 40, damageType: "all", targeting: "self", canTargetPartner: false, isInvuln: false, minLevel: 92, notes: "预警的 92 级升级版，附带护盾效果。" },
  ...
  { id: "war-vengeance", job: "WAR", zhName: "复仇", enName: "Vengeance", category: "personal", cooldown: 120, duration: 15, mitigationPercent: 30, damageType: "all", targeting: "self", canTargetPartner: false, isInvuln: false, minLevel: 38, maxLevel: 91, notes: "92 级后由复仇精通升级为戮罪。" },
  { id: "war-damnation", job: "WAR", zhName: "戮罪", enName: "Damnation", category: "personal", cooldown: 120, duration: 15, mitigationPercent: 40, damageType: "all", targeting: "self", canTargetPartner: false, isInvuln: false, minLevel: 92, notes: "复仇的 92 级升级版，附带反击与恢复相关效果。" },
  ...
  { id: "drk-shadow-wall", job: "DRK", zhName: "暗影墙", enName: "Shadow Wall", category: "personal", cooldown: 120, duration: 15, mitigationPercent: 30, damageType: "all", targeting: "self", canTargetPartner: false, isInvuln: false, minLevel: 38, maxLevel: 91, notes: "92 级后由暗影墙精通升级为暗影卫。" },
  ...
  { id: "drk-shadowed-vigil", job: "DRK", zhName: "暗影卫", enName: "Shadowed Vigil", category: "personal", cooldown: 120, duration: 15, mitigationPercent: 40, damageType: "all", targeting: "self", canTargetPartner: false, isInvuln: false, minLevel: 92, notes: "暗影墙的 92 级升级版，附带 Vigilant 恢复效果。" },
  ...
  { id: "gnb-nebula", job: "GNB", zhName: "星云", enName: "Nebula", category: "personal", cooldown: 120, duration: 15, mitigationPercent: 30, damageType: "all", targeting: "self", canTargetPartner: false, isInvuln: false, minLevel: 38, maxLevel: 91, notes: "92 级后由星云精通升级为大星云。" },
  ...
  { id: "gnb-great-nebula", job: "GNB", zhName: "大星云", enName: "Great Nebula", category: "personal", cooldown: 120, duration: 15, mitigationPercent: 40, damageType: "all", targeting: "self", canTargetPartner: false, isInvuln: false, minLevel: 92, notes: "星云的 92 级升级版。" },
];
