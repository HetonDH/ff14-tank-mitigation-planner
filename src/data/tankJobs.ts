...
export const tankSkills: MitigationSkill[] = [
  ...
  { id: "pld-cover", actionId: 27, job: "PLD", zhName: "保护", enName: "Cover", icon: "/i/002000/002501.png", category: "target", cooldown: 120, duration: 12, mitigationPercent: null, damageType: "all", targeting: "selected", canTargetPartner: true, isInvuln: false, minLevel: 45, statusIds: [79], notes: "替目标承受部分攻击，实际可用性受距离与机制判定影响。" },
