...
export const exampleTimeline: TimelineEvent[] = [
  ...
  { id: "ex-003", time: 48, name: "MT 单体死刑", damage: 145000, type: "singleTankbuster", damageType: "physical", target: "MT", severity: "high", notes: "单体物理死刑" },
  { id: "ex-004", time: 72, name: "双 T 分摊死刑", damage: 132000, type: "sharedTankbuster", damageType: "all", target: "bothTanks", severity: "lethal", notes: "可考虑无敌逃课或双 T 分担减伤" },
  ...
  { id: "ex-008", time: 176, name: "双 T 分散死刑", damage: 158000, type: "spreadTankbuster", damageType: "physical", target: "bothTanks", severity: "lethal", notes: "高危双 T 分散处理点" },
];
